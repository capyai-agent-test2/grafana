...
If you're using self-managed Grafana and want to try preview features from this release, refer to [Configure feature toggles](../setup-grafana/configure-grafana/feature-toggles/).
